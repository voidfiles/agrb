...
(function ()
{
var h=true,i=null,j=false,k,aa="/reader/link-frame";
var n=this;
function ba(a,b)
{
a=a.split(".");
...
{
if(a.hasOwnProperty&&a.hasOwnProperty(u))return a[u];
a[u]||(a[u]=++da);
return a[u]
}var u="closure_hashCode_"+Math.floor(Math.random()*2147483648).toString(36),da=0;
function ea(a,b)
{
var c=b||n;
...
function y(a,b)
{
if(b)return a.replace(ia,"&amp;
").replace(ja,"&lt;
").replace(ka,"&gt;
").replace(la,"&quot;
");
else{if(!ma.test(a))return a;
...
}var ia=/&/g,ja=/</g,ka=/>/g,la=/\"/g,ma=/[&<>\"]/;
function na(a)
{
var b=n.document.createElement("a");
b.innerHTML=a;
...
{
a=a;
a=z(a,"&")?"document"in n&&!z(a,"<")?na(a):oa(a):a
...
e++)
{
var f=a[e]||"",m=b[e]||"",g=new RegExp("(\\d*)(\\D*)","g"),s=new RegExp("(\\d*)(\\D*)","g");
do{var l=g.exec(f)||["","",""],o=s.exec(m)||["","",""];
...
var b=G();
C=a.indexOf("Opera")==0;
D=!C&&a.indexOf("MSIE")!=-1;
qa=(E=!C&&a.indexOf("WebKit")!=-1)&&a.indexOf("Mobile")!=-1;
F=!C&&!E&&b.product=="Gecko"
}
})();
var sa=C,H=D,ta=F,I=E,J=function()
{
var a=G();
return a&&a.platform||""
}();
...
else if(I)b=/WebKit\/(\S+)/;
if(b)a=(a=b.exec(ra()))?a[1]:""
}return a
}(),L={
};
function M()
...
{
a.b.length<a.u?a.b.push(b):va(a,b)
}function va(a,b)
{
if(a.p)a.p(b);
else if(t(b.i)=="function")b.i();
...
(function()
{
xa=(wa="ScriptEngine"in n&&n.ScriptEngine()=="JScript")?n.ScriptEngineMajorVersion()+"."+n.ScriptEngineMinorVersion()+"."+n.ScriptEngineBuildVersion():"0"
})();
var ya=wa,za=xa;
function Aa()
{
...
{
if(this.t)return this.m.call(this.H||this.src,a);
return this.m.handleEvent.call(this.m,a)
};
var R,Ca,S,Da,Ea,Fa,Ga,Ha;
(function()
{
function a()
{
...
var b=T[a];
if(b.g)return j;
var c=b.src,d=b.type,e=b.w,f=b.capture;
if(c.removeEventListener)
{
if(c==n||!c.L)c.removeEventListener(d,e,f)
}else c.detachEvent&&c.detachEvent(La(d),e);
c=ca(c);
e=U[d][f][c];
if(Ia[c])
{
var m=Ia[c],g=fa(m,b);
g>=0&&w.splice.call(m,g,1).length==1;
m.length==0&&delete Ia[c]
}b.g=h;
e.v=h;
Ma(d,f,c,e);
delete T[a];
...
a:{var g=j;
if(e.keyCode==0)try{e.keyCode=-1;
break a
}catch(s)
{
g=h
...
try{if(b)
{
for(var l=Ca(),o=g.currentTarget;
o;
o=o.parentNode)l.push(o);
f=d[h];
f.f=f.c;
...
}I&&(L["522"]||(L["522"]=A(K,"522")>=0));
function Qa(a)
{
if(!a)return"";
if(a.indexOf("x-")==0)a=a.substring(2);
return x(a.split("/")[0]).toLowerCase()
}
function Ra()
{
var a={
...
{
_LINK_BOOKMARKLET_IS_STANDALONE?window.location.reload(h):Sa(top,_OPENER_URL,"#refresh=1")
}function W()
{
...
{
for(var a=document.getElementsByTagName("meta"),b=0,c;
c=a[b];
b++)
{
...
{
var a=window.location.hostname,b=a.length-11;
if(!(b>=0&&a.lastIndexOf("youtube.com",b)==b))return i;
if("/watch"!=window.location.pathname)return i;
a=document.getElementById("embed_code");
b=a.value;
b=/^[\s\xa0]*$/.test(b==i?"":String(b))?j:b.toLowerCase().indexOf("<object")==0||b.toLowerCase().indexOf("<embed")==0;
if(b)return a.value;
a=window.location.search;
b=a.search(Pa);
var c;
c:{for(c=0;
(c=a.indexOf("v",c))>=0&&c<b;
)
{
...
}a=a?"http://i.ytimg.com/vi/"+a+"/0.jpg":i;
if(a)return'<a href="'+window.location+'"><img src="'+a+'"></a><br><a href="'+window.location+'">'+window.location+"</a>";
return i
};
var Xa=[new Wa,new Ta,new Va,new W];
function Ya(a,b,c)
{
if(a[b])
{
Sa(window,window.location.href,"#");
c()
}
}
function Za()
{
return(window.GR________bookmarklet_domain||window.location.protocol+"//"+window.location.host)+aa
}function $a()
{
var a=new X;
a.C=document.title;
...
var a=new X;
db(a);
a.k='<img src="'+document.location.href+'">';
return a
}function eb()
{
var a=new X;
db(a);
a.k='<a href="'+document.location.href+'">Video</a>';
return a
}
function fb()
{
var a=new X;
db(a);
var b="<pre>"+document.getElementsByTagName("pre")[0].innerHTML+"</pre>";
a.k=b;
return a
}var Y=i;
function Z(a,b)
...
this.l=a;
this.F=b
}Z.prototype.clear=function(a)
{
window.clearInterval(this.I);
if(!this.l)
{
var b=V("GR________link_bookmarklet_node");
b.innerHTML="";
...
function gb()
{
if(I)return window.frames.GR________link_bookmarklet_frame;
var a=V("GR________link_bookmarklet_frame");
return a?a.contentWindow:i
}
Z.prototype.G=function()
{
if(this.l||(gb(this)?h:j))
{
var a=Ra(),b=this;
Ya(a,"refresh",function()
{
b.clear();
b.e($a())
});
Ya(a,"close",ea(b.clear,b,h))
}
};
Z.prototype.e=function(a)
{
this.l?hb(this,a):ib(this,a);
this.I=window.setInterval(ea(this.G,this),50)
};
function hb(a,b)
{
if(window.open(a.F?jb(b,Za()):"","GR________link_bookmarklet_frame","height=378,width=520"))a.F||kb(a,b);
...
if(!(gb(a)?h:j))
{
V("GR________link_bookmarklet_node").innerHTML='<iframe frameborder="0" id="GR________link_bookmarklet_frame" name="GR________link_bookmarklet_frame" style="width:100%;
height:100%;
border:0px;
padding:0px;
margin:0px"></iframe>';
...
{
a=lb(b,Za(),"GR________link_bookmarklet_frame");
document.body.appendChild(a);

// a.submit()
// We will do this after we shorten the url.
}function X()
{
}
function db(a)
...
{
if(a.K)b("srcItemId",a.K);
else{b("title",a.C);
b("url",a.D);
b("srcTitle",a.z);
b("srcUrl",a.A);
b("snippet",pa(a.k,1E5))
}
}
function lb(a,b,c) {
    function d(m,g) {
...
if(f<0)d[1]="?";
else if(f==e.length-1)d[1]=undefined
}c=d.join("")
}
});
return c
...
var a=V("GR________link_bookmarklet_node");
if(!a)
{
...
a.style.border="4px solid #c3d9ff";
a.style.top="8px";
a.style.right="8px";
a.style.width="520px";
...
})("removeLinkFrame",function()
{
Y.clear(h)
});
var ob;
var pb=window;
try{ob=pb._USER_ID!==undefined&&pb._USER_EMAIL!==undefined
}catch(qb)
{
ob=j
}if(!ob)if(bb("video","embed"))$(eb(),h,h);
else if(bb("image","img"))$(cb(),I?j:h,I?j:h);
else bb("","pre")?$(fb(),h,h):$($a());
})();
