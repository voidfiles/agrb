(function() {
    ...
    var u = "closure_hashCode_" + Math.floor(Math.random() * 2147483648).toString(36),
    da = 0;
    function ea(a, b) {
        var c = b || n;
    ...
    function P(a, b) {
        ...
        for (b = 0; b < a; b++) this.b.push(this.a ? this.a() : {})
    }
    v(P, M);
    P.prototype.a = i;
    P.prototype.p = i;
    ...
    P.prototype.d = function() {
        P.B.d.call(this);
        for (var a = this.b; a.length;) va(this, a.pop());
        delete this.b
    };
    var wa,
    xa; (function() {
    ...
    function Ma(a, b, c, d) {
        if (!d.j) if (d.v) {
            for (var e = 0, f = 0; e < d.length; e++) if (d[e].g) {
                var m = d[e].w;
                m.src = i;
                Ea(m);
                Fa(d[e])
    ...
    Da(function(a, b) {
        ...
        if (H) {
            ...
            try {
                if (b) {
                    for (var l = Ca(), o = g.currentTarget; o; o = o.parentNode) l.push(o);
                    f = d[h];
                    f.f = f.c;
                    for (var q = l.length - 1; ! g.n && q >= 0 && f.f; q--) {
                        g.currentTarget = l[q];
                        e &= Na(f, l[q], 
                        c, h, g)
                    }
    ...
    Wa.prototype.h = function() {
        ...
        b = a.value;
        b = /^[sxa0]*$/.test(b == i ? "": String(b)) ? j: b.toLowerCase().indexOf("<object") == 0 || b.toLowerCase().indexOf("<embed") == 0;
        if (b) return a.value;
        a = window.location.search;
        b = a.search(Pa);
        var c;
        c: {
            for (c = 0; (c = a.indexOf("v", c)) >= 0 && c < b;) {
    ...
    function ib(a, b) {
        if (! (gb(a) ? h: j)) {
            V("GR________link_bookmarklet_node").innerHTML = '<iframe frameborder="0" id="GR________link_bookmarklet_frame" name="GR________link_bookmarklet_frame" style="width:100%;height:100%;border:0px;padding:0px;margin:0px"></iframe>';
            kb(a, b)
        }
    }
    function kb(a, b) {
    ...
    (function(a, b, c) {
        a = a.split(".");
        c = c || n; ! (a[0] in c) && c.execScript && c.execScript("var " + a[0]);
    ...
    var pb = window;
    try {
        ob = pb._USER_ID !== undefined && pb._USER_EMAIL !== undefined
    } catch(qb) {
        ob = j
    }
