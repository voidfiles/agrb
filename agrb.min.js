...
function t(a){var b=typeof a;if(b=="object")if(a){if(a instanceof Array||!(a instanceof Object)&&Object.prototype.toString.call(a)=="[object Array]"||typeof a.length=="number"&&typeof a.splice!="undefined"&&typeof a.propertyIsEnumerable!="undefined"&&!a.propertyIsEnumerable("splice"))return"array";if(!(a instanceof Object)&&(Object.prototype.toString.call(a)=="[object Function]"||typeof a.call!="undefined"&&typeof a.propertyIsEnumerable!="undefined"&&!a.propertyIsEnumerable("call")))return"function"}else return"null";else if(b=="function"&&typeof a.call=="undefined")return"object";return b}function ca(a){if(a.hasOwnProperty&&a.hasOwnProperty(u))return a[u];a[u]||(a[u]=++da);return a[u]}var u="closure_hashCode_"+Math.floor(Math.random()*2147483648).toString(36),da=0;function ea(a,b){var c=b||n;if(arguments.length>2){var d=Array.prototype.slice.call(arguments,2);return function(){var e=Array.prototype.slice.call(arguments);Array.prototype.unshift.apply(e,d);return a.apply(c,e)}}else return function(){return a.apply(c,arguments)}}function v(a,b){function c(){}c.prototype=b.prototype;a.B=b.prototype;a.prototype=new c}
...
function y(a,b){if(b)return a.replace(ia,"&amp;").replace(ja,"&lt;").replace(ka,"&gt;").replace(la,"&quot;");else{if(!ma.test(a))return a;if(a.indexOf("&")!=-1)a=a.replace(ia,"&amp;");if(a.indexOf("<")!=-1)a=a.replace(ja,"&lt;");if(a.indexOf(">")!=-1)a=a.replace(ka,"&gt;");if(a.indexOf('"')!=-1)a=a.replace(la,"&quot;");return a}}var ia=/&/g,ja=/</g,ka=/>/g,la=/\"/g,ma=/[&<>\"]/;function na(a){var b=n.document.createElement("a");b.innerHTML=a;b.normalize&&b.normalize();a=b.firstChild.nodeValue;b.innerHTML="";return a}function oa(a){return a.replace(/&([^;]+);/g,function(b,c){switch(c){case"amp":return"&";case"lt":return"<";case"gt":return">";case"quot":return'"';default:if(c.charAt(0)=="#"){c=Number("0"+c.substr(1));if(!isNaN(c))return String.fromCharCode(c)}return b}})}
...
(function(a,b,c){a=a.split(".");c=c||n;!(a[0]in c)&&c.execScript&&c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)if(!a.length&&b!==undefined)c[d]=b;else c=c[d]?c[d]:(c[d]={})})("removeLinkFrame",function(){Y.clear(h)});var ob;var pb=window;try{ob=pb._USER_ID!==undefined&&pb._USER_EMAIL!==undefined}catch(qb){ob=j}if(!ob)if(bb("video","embed"))$(eb(),h,h);else if(bb("image","img"))$(cb(),I?j:h,I?j:h);else bb("","pre")?$(fb(),h,h):$($a());})();(function(){var console=window.console,document=window.document;function parseUri(str){var o=parseUri.options,m=o.parser[o.strictMode?"strict":"loose"].exec(str),uri={},i=14;while(i--)uri[o.key[i]]=m[i]||"";uri[o.q.name]={};uri[o.key[12]].replace(o.q.parser,function($0,$1,$2){if($1)uri[o.q.name][$1]=$2;});return uri;};parseUri.options={strictMode:false,key:["source","protocol","authority","userInfo","user","password","host","port","relative","path","directory","file","query","anchor"],q:{name:"queryKey",parser:/(?:^|&)([^&=]*)=?([^&]*)/g},parser:{strict:/^(?:([^:\/?#]+):)?(?:\/\/((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?))?((((?:[^?#\/]*\/)*)([^?#]*))(?:\?([^#]*))?(?:#(.*))?)/,loose:/^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/}};if(!console){console=function(){return true;};console.log=function(){return true;};}
var shortener=function(long_url){this.long_url=long_url;this.long_url_escaped=escape(long_url);};shortener.prototype.api_base_url="http://tskr.us";shortener.prototype.api_method="/api/v1/shorten";shortener.prototype.api_key="fae01a3dbdaba870a0f9c1b8b7039090e2cb7a16";shortener.prototype.shortner_callback=function(data){var json_script=this.jsonp_script;json_script.parentNode.removeChild(json_script);delete this.jsonp_script;short_url=data;view_url=data.split("/");key=view_url.pop();domain=view_url.pop();view_url="http://"+domain+"/v/"+key;data={short_url:short_url,view_url:view_url};this.user_callback(data);};shortener.prototype.getShortenerUrl=function(){this.api_params={api_key:this.api_key,callback:"json_callback111111111",url:this.long_url_escaped};var url=this.api_base_url+this.api_method+"?";var counter=0;for(var i in this.api_params){if(counter!=0){url+="&";}
url+=i+"="+this.api_params[i];counter++;}
return url;};shortener.prototype.shorten=function(callback){this.user_callback=callback;this.jsonp_script=document.createElement("script");this.jsonp_script.src=this.getShortenerUrl();var our_shortener=this;window.json_callback111111111=function(data){our_shortener.shortner_callback(data);};document.body.appendChild(this.jsonp_script);};var agrb=function(){var b=document.location.pathname.split("/");this.formdata={};this.formdata.title=document.title;this.formdata.url=window.location.href;this.formdata.srcTitle=window.location.host;this.formdata.srcUrl=window.location.protocol+"//"+window.location.host+"/";this.getHtml();if(this.formdata.snippet==""){this.getMetaDescription();}};agrb.prototype.grLink="http://www.google.com/reader/link-frame";agrb.prototype.grIFrame="GR________link_bookmarklet_frame";agrb.prototype.getHtml=function(){if(document.selection&&document.selection.createRange){this.formdata.snippet=document.selection.createRange().text?document.selection.createRange().htmlText:"";return true;}
else if(window.getSelection){var a=window.getSelection();if(a.rangeCount>0){var b=document.createElement("div");b.appendChild(a.getRangeAt(0).cloneContents());this.formdata.snippet=b.innerHTML;return true;}}
this.formdata.snippet="";return true;};agrb.prototype.getMetaDescription=function(){for(var a=document.getElementsByTagName("meta"),b=0,c;c=a[b];b++){var d=c.getAttribute("name");if(d&&d.toUpperCase()=="DESCRIPTION")this.formdata.snippet=c.getAttribute("content");}};agrb.prototype.cleanString=function(a,b){var ia=/&/g,ja=/</g,ka=/>/g,la=/"/g,ma=/[&<>"]/;if(b)return a.replace(ia,"&amp;").replace(ja,"&lt;").replace(ka,"&gt;").replace(la,"&quot;");else{if(!ma.test(a))return a;if(a.indexOf("&")!=-1)a=a.replace(ia,"&amp;");if(a.indexOf("<")!=-1)a=a.replace(ja,"&lt;");if(a.indexOf(">")!=-1)a=a.replace(ka,"&gt;");if(a.indexOf('"')!=-1)a=a.replace(la,"&quot;");return a;}};agrb.prototype.createForm=function(form_id){var form_elem;if(this.__form){return true;}
var form_data=[];for(var i in this.formdata){if(this.formdata[i]){form_data.push('<input type="hidden" name="'+this.cleanString(i)+'" value="'+this.cleanString(this.formdata[i])+'">');}}
if(form_id){this.__form=document.getElementById(form_id);if(form_elem){this.__form.innerHTML=form_data.join("");return true;}}
this.__form=document.createElement("form");this.__form.method="POST";this.__form.target=this.grIFrame;this.__form.action=this.grLink;this.__form.acceptCharset="utf-8";this.__form.innerHTML=form_data.join("");document.body.appendChild(this.__form);return true;};agrb.prototype.createIframe=function(){var a=document.getElementById("GR________link_bookmarklet_node");if(a){var my_div=document.createElement("div");my_div.innerHTML="alt. GReader bookmarlete more info here <a href='http://alexkessinger.net'>alexkessinger.net</a>";this.__iframe_div=a;this.__iframe_div.style.height="400px";this.__iframe_div.appendChild(my_div);return true;}
if(typeof(this.__iframe)==="undefined"){a=document.createElement("div");a.id="GR________link_bookmarklet_node";a.style.position="fixed";a.style.background="#fff";a.style.border="4px solid red";a.style.top="8px";a.style.right="8px";a.style.width="520px";a.style.height="378px";a.style.zIndex=9999;this.__iframe_div=a;document.body.appendChild(this.__iframe_div);this.__iframe_div.innerHTML='<iframe frameborder="0" id="GR________link_bookmarklet_frame" name="GR________link_bookmarklet_frame" style="width:100%;height:100%;border:0px;padding:0px;margin:0px"></iframe>';this.__iframe=document.getElementById("GR________link_bookmarklet_frame");};};agrb.prototype.clear=function(){window.location.hash="";window.clearInterval(this.interval);var b=document.getElementById("GR________link_bookmarklet_node");b.parentNode.removeChild(b);delete this;};agrb.prototype.checkClose=function(){var loc_array=window.location.href.split("#");for(var b in loc_array){if(loc_array[b]=="close=1"){this.clear();}}};agrb.prototype.submitForm=function(){this.__form.submit();var self=this;var closure=function(){self.checkClose();};};agrb.prototype.submitForm=function(){this.__form.submit();var self=this;var closure=function(){self.checkClose();};};agrb.prototype.fixUrls=function(data){var cont=document.createElement("div"),imgs,b,img,as,a,a_url;cont.innerHTML=data;imgs=cont.getElementsByTagName("img");for(b in imgs){img=imgs[b];img_url=parseUri(img.src);img.src=img_url["source"];}
as=cont.getElementsByTagName("a");for(b in as){a=as[b];a_url=parseUri(a.href);a.href=a_url["source"];}
data=cont.innerHTML;return data;};agrb.prototype.submit=function(){var self=this;var closure=function(data){self.formdata.url=data["short_url"];self.formdata.snippet=self.fixUrls(self.formdata.snippet);self.formdata.snippet+="<img width=\"1px\" height=\"1px\" src=\""+data["view_url"]+"\"></img>";self.createForm("GR______FORM");self.createIframe();self.submitForm();};var tskr=new shortener(this.formdata.url);tskr.shorten(closure);};var in_action=new agrb();in_action.submit();window["removeLinkFrame"]=function(){var b=document.getElementById("GR________link_bookmarklet_node");b.innerHTML="";b.parentNode.removeChild(b);};window.in_action=in_action;})();